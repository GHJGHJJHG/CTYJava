...
/**Monty Carlo simulation of the likely hood of encountering a red queen at any given position at a shuffled deck. 
 * @deprecated Support has been halted since version 1.2 of Card and CardDeck
 * @version 1.2
 */
public class FirstRedQueen {
	
	static CardDeck deck = new CardDeck(CardDeck.Variant.STANDARD);
	...
	private static int firstQueenIndex()
	{
		for (int i = 0; i < deck.getSize(); i++)
		{
			...
			if (singleCard.getValue() == Card.QUEEN && (singleCard.getSuit() == Card.Suit.CLUB || singleCard.getSuit() == Card.Suit.DIAMOND))
				return i;
		}
